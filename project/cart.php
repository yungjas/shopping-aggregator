        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo02">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="cart.php">Cart <i class="fas fa-shopping-cart"></i></a>
                    </li>
    ...
    <div class="container" style="margin-top: 40px;">
        <div class="row justify-content-center">
            <div class="col-auto border rounded bg-primary text-white animate__animated animate__heartBeat text-center">
                <h4 style="margin-top: 8px;"><span class="font-weight-light">Total Damage:</span> $504.30</h4>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="align-middle">
                        <a href="delete.php" class="btn btn-danger btn-sm mb-2">Remove</a> <a href="delete.php" class="btn btn-primary btn-sm mb-2">Buy!</a>
                    </td>
                </tr>
